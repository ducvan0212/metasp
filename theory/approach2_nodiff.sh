...
}' potential_plus.lp > resolved_underscore_potential_plus.lp
...
}' resolved_underscore_potential_plus.lp >> Pi_x.lp
...
}' potential_minus.lp > resolved_underscore_potential_minus.lp
...
}' resolved_underscore_potential_minus.lp >> Pi_x.lp
